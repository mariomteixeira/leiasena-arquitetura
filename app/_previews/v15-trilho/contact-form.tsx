 ...
 * com a marcação e os estados desenhados para o mundo "Marquise · Trilho".
 */
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col gap-7">
            ...
            <div className="tr-field">
                <label htmlFor="tr-nome" className="sr-only">
                    Nome
                </label>
                <input
                    id="tr-nome"
            ...
            <div className="tr-field">
                <label htmlFor="tr-tel" className="sr-only">
                    Telefone
                </label>
                <input
                    id="tr-tel"
                    ...
                    aria-describedby={phoneError ? "tr-tel-erro" : undefined}
                ...
                />
                {phoneError && (
                    <p id="tr-tel-erro" className="tr-field-note">
            ...
            <div className="tr-field">
                ...
                <input
                    ...
                    aria-describedby={emailError ? "tr-email-erro" : undefined}
                ...
                />
                {emailError && (
                    <p id="tr-email-erro" className="tr-field-note">
                        <IconAlert className="h-4 w-4 shrink-0" />
                        Email inválido
                    </p>
                )}
            ...
            <div className="tr-field">
                <label htmlFor="tr-tipo" className="sr-only">
                    Tipo de projeto
                </label>
                <select
                    id="tr-tipo"
                    ...
                    className={`tr-input tr-select ${form.tipoProjeto ? "" : "text-navy/50"}`}
                >
            ...
            <button
                ...
                className="tr-cta group mt-1 inline-flex h-14 items-center justify-center gap-3 rounded-full bg-navy px-9 text-[0.8rem] font-light uppercase tracking-[0.18em] text-cream hover:bg-navy/90 disabled:opacity-60"
            >
