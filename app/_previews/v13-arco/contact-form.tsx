 ...
 * com a marcação e os estados desenhados para o mundo "Arco".
 */
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col gap-7">
            ...
            <div className="ac-field">
                <label htmlFor="ac-nome" className="sr-only">
                    Nome
                </label>
                <input
                    id="ac-nome"
            ...
            <div className="ac-field">
                <label htmlFor="ac-tel" className="sr-only">
                    Telefone
                </label>
                <input
                    id="ac-tel"
                    ...
                    aria-describedby={phoneError ? "ac-tel-erro" : undefined}
                ...
                />
                {phoneError && (
                    <p id="ac-tel-erro" className="ac-field-note">
            ...
            <div className="ac-field">
                ...
                <input
                    ...
                    aria-describedby={emailError ? "ac-email-erro" : undefined}
                ...
                />
                {emailError && (
                    <p id="ac-email-erro" className="ac-field-note">
                        <IconAlert className="h-4 w-4 shrink-0" />
                        Email inválido
                    </p>
                )}
            ...
            <div className="ac-field">
                <label htmlFor="ac-tipo" className="sr-only">
                    Tipo de projeto
                </label>
                <select
                    id="ac-tipo"
                    ...
                    className={`ac-input ac-select ${form.tipoProjeto ? "" : "text-navy/60"}`}
                >
            ...
            <button
                ...
                className="ac-cta group mt-1 inline-flex h-14 items-center justify-center gap-3 rounded-full bg-navy px-9 text-[0.8rem] font-light uppercase tracking-[0.18em] text-cream hover:bg-navy/90 disabled:opacity-60"
            >
