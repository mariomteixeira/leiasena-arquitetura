...
/** seta dentro de um arco — o mesmo gesto do carrossel, desenhado */
export function IconArcLeft({ className }: IconProps) {
    return (
        <svg viewBox="0 0 24 24" className={className} aria-hidden="true" {...base}>
...
export function IconArcRight({ className }: IconProps) {
    return (
        <svg viewBox="0 0 24 24" className={className} aria-hidden="true" {...base}>
