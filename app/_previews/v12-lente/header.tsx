...
export default function Header() {
    ...
    return (
        <>
            ...
            {open && (
                <div className="ln-menu fixed inset-0 z-[60] bg-cream md:hidden" role="dialog" aria-modal="true">
                    ...
                    <nav className="flex flex-col px-5 pt-6" aria-label="Principal">
                        {copy.sections.map((s, i) => (
                            <a
                                ...
                                className="ln-menu-item ln-hair-soft py-5 font-serif text-[2.35rem] leading-none text-navy first:border-t-0"
                            >
                                {s.label}
                            </a>
                        ))}
                    ...
                    <div
                        className="ln-menu-item absolute inset-x-5 bottom-9 flex flex-col gap-2 font-mono text-[0.72rem] uppercase tracking-[0.16em] text-navy/70"
                        style={{ ["--d" as string]: "420ms" }}
                    >
                        <a href={brand.whatsapp.href} target="_blank" rel="noreferrer" className="ln-link w-fit">
                            {brand.whatsapp.display}
                        </a>
                        <a href={brand.instagram.href} target="_blank" rel="noreferrer" className="ln-link w-fit">
