...
/**
 * Mesma lógica de validação de antes e o mesmo endpoint /api/contact,
 * com a marcação e os estados desenhados para o mundo "Marquise · Fita".
 */
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col gap-7">
            ...
            <div className="ft-field">
                <label htmlFor="ft-nome" className="sr-only">
                    Nome
                </label>
                <input
                    id="ft-nome"
            ...
            <div className="ft-field">
                <label htmlFor="ft-tel" className="sr-only">
                    Telefone
                </label>
                <input
                    id="ft-tel"
                    ...
                    aria-describedby={phoneError ? "ft-tel-erro" : undefined}
                ...
                />
                {phoneError && (
                    <p id="ft-tel-erro" className="ft-field-note">
            ...
            <div className="ft-field">
                ...
                <input
                    ...
                    aria-describedby={emailError ? "ft-email-erro" : undefined}
                ...
                />
                {emailError && (
                    <p id="ft-email-erro" className="ft-field-note">
                        <IconAlert className="h-4 w-4 shrink-0" />
                        Email inválido
                    </p>
                )}
            ...
            <div className="ft-field">
                <label htmlFor="ft-tipo" className="sr-only">
                    Tipo de projeto
                </label>
                <select
                    id="ft-tipo"
                    ...
                    className={`ft-input ft-select ${form.tipoProjeto ? "" : "text-navy/50"}`}
                >
            ...
            <button
                ...
                className="ft-cta group mt-1 inline-flex h-14 items-center justify-center gap-3 rounded-full bg-navy px-9 text-[0.8rem] font-light uppercase tracking-[0.18em] text-cream hover:bg-navy/90 disabled:opacity-60"
            >
